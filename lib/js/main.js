//不同语言
var zh =
    '{"h2_start":"测试","text_start":"在成为正式玩家之前请回答题目。</br>注意！你仅有120分钟的答题时间。","h2_end":"非常棒，你完成了测试。","text_end":"谢谢。请输入你的Xbox ID并等待我们的回复！","leave_warning":"您离开答题页面时间过长，页面已自动关闭，请手动刷新以重新开始","timeOut_warning":"时间到，终止答题，答题页面已自动关闭，请手动刷新以重新开始","title_warning":"答题过程中请勿离开页面","notice_warning":"注意！您已经离开答题页面！离开5秒后页面将自动关闭！这将不会保存您的任何记录！请马上回到答题页面！"}';
var en =
    '{"h2_start":"TEST","text_start":"Please answer the questions to be a formal player.</br>Be careful! You only have 120 minutes to answer questions.","h2_end":"Great.That is all.","text_end":"Thank you. Please input your Xbox ID and wait for our reply.","leave_warning":"You have been away from the TEST page for too long. The page has been closed automatically. Please refresh manually to start again.","timeOut_warning":"The time is up. Stop answering. The TEST page has been closed automatically. Please refresh manually to start again.","title_warning":"Do not leave the page during the TEST","notice_warning":"Be careful! You have left the TEST page! The page will close automatically after 5 seconds! This will not save any of your records! Please go back to the TEST page now!"}';
